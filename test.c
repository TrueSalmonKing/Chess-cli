...
//boundary check with !(~~((test2[1]-'1')>>3)&&~~((test2[2]-1)>>3)) where the value is shifted by 3 bits after substracting one to ensure that it is between 1 (0b0001) and 8 (0b0100) (bit shift works conveniently since we have an upper bound power of 2)
